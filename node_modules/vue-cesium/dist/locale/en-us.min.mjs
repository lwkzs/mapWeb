...
and click the right button to discard the modification.`},clear:{tip:"Clear analysis results"}},overview:{show:"Show",hidden:"Hidden"},typhoon:{warn:"Failed to play typhoon, reason: no typhoon data with corresponding number found."}}};export{t as default};
//# sourceMappingURL=en-us.min.mjs.map
