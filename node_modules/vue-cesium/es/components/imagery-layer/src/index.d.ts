...
declare const emits: {
    ...
    readyEvent: (payload: VcImageryProvider) => boolean;
    errorEvent: (payload: Error) => boolean;
...
export declare const imageryLayerProps: {
    ...
    cutoutRectangle: {
        ...
        watcherOptions: {
            cesiumObjectBuilder: typeof import("vue-cesium/es/utils/cesium-helpers").makeRectangle;
        };
    };
...
declare const _default: import("vue").DefineComponent<{
    ...
    onErrorEvent?: (payload: Error) => any;
    "onUpdate:imageryProvider"?: (payload: VcImageryProvider) => any;
    onReadyEvent?: (payload: VcImageryProvider) => any;
}, {
    show: boolean;
