...
declare const _Measurements: SFCWithInstall<import("vue").DefineComponent<{
    ...
    clearEvt: (e: {
        type: "clear";
        option: import("vue-cesium/es/utils/types").VcActionTooltipProps;
    ...
    drawEvt: (evt: {
        ...
        renderDatas: import("vue").Ref<(import("../../utils/drawing-types").VcPointDrawing | import("../../utils/drawing-types").VcPolylineDrawing | import("../../utils/drawing-types").VcSegmentDrawing)[]>;
        finished: boolean;
    ...
    fabActionOpts: import("vue-cesium/es/utils/types").VcActionTooltipProps;
    activeColor: string;
