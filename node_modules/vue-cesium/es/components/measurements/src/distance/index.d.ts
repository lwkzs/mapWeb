...
declare const _default: import("vue").DefineComponent<{
    ...
    distanceFormatter: PropType<import("@vue-cesium/utils/drawing-types").VcMeasurementFormatter>;
    angleFormatter: PropType<import("@vue-cesium/utils/drawing-types").VcMeasurementFormatter>;
    areaFormatter: PropType<import("@vue-cesium/utils/drawing-types").VcMeasurementFormatter>;
    enableMouseEvent: {
        type: BooleanConstructor;
        default: boolean;
    };
    ...
    drawEvt: (evt: {
        ...
        renderDatas: Ref<(import("@vue-cesium/utils/drawing-types").VcPointDrawing | import("@vue-cesium/utils/drawing-types").VcPolylineDrawing | VcSegmentDrawing)[]>;
        finished: boolean;
        position?: Cesium.Cartesian3;
        windowPoistion: Cesium.Cartesian2;
        type: "move" | "insert" | "remove" | "removeAll" | "cancel" | "new";
