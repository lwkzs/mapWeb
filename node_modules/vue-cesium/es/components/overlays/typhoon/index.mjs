import { defineComponent, getCurrentInstance, ref, reactive, h } from 'vue';
import '../../../composables/index.mjs';
import { makeCartesian3Array } from '../../../utils/cesium-helpers.mjs';
import { commonEmits } from '../../../utils/emits.mjs';
import { VcCollectionPoint, VcCollectionLabel, VcPolygon, VcCollectionPrimitive } from '../../primitive-collections/index.mjs';
import { merge, cloneDeep, uniqWith } from 'lodash-es';
import useLog from '../../../composables/private/use-log.mjs';
import { VcPrimitive } from '../../primitives/index.mjs';
import { VcGeometryInstance } from '../../geometry-instance/index.mjs';
import { VcGeometryPolyline } from '../../geometries/index.mjs';
    ...
    const getChildren = (datasources, centerPointCircle) => {
      ...
      datasources.forEach((typhoonDatasource) => {
        if (typhoonDatasource.positions.length > 1) {
          const linePrimitiveProps = typeof props.linePrimitiveProps === "function" ? merge(cloneDeep(defaultLinePrimitiveProps), props.linePrimitiveProps(typhoonDatasource)) : props.linePrimitiveProps;
          const lineGeometryProps = typeof props.lineGeometryProps === "function" ? merge(cloneDeep(defaultLineGeometryProps), props.lineGeometryProps(typhoonDatasource)) : props.lineGeometryProps;
          children.push(
            h(
              VcPrimitive,
              {
        ...
        if (typhoonDatasource.type === "live") {
          const labelProps = typeof props.labelProps === "function" ? merge(cloneDeep(defaultLabelProps), props.labelProps(typhoonDatasource)) : props.labelProps;
          children.push(
            h(VcCollectionLabel, {
              show: typhoonDatasource.show,
              enableMouseEvent: false,
...
export { OverlayTyphoon as default, typhoonOverlayProps };
