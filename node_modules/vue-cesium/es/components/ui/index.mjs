...
const VcSlider = Slider;

export { VcAjaxBar, VcBtn, VcFab, VcFabAction, VcIcon, VcSkeleton, VcSlider, VcSpinner, VcSpinnerBall, VcSpinnerBars, VcSpinnerDots, VcSpinnerGears, VcSpinnerHourglass, VcSpinnerIos, VcSpinnerOrbit, VcSpinnerOval, VcSpinnerPuff, VcSpinnerRings, VcSpinnerTail, VcTooltip, index as default };
