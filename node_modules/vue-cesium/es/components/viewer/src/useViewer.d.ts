...
import type { VcComponentInternalInstance, VcCamera, VcReadyObject, VcComponentPublicInstance, VcTerrainProvider, VcDatasource, ViewerWidgetResizedEvent, VcContextOptions, VcViewerProvider, Mars3dConfig, DCConfig } from 'vue-cesium/es/utils/types';
...
export declare const viewerProps: {
    ...
    viewerCreator: import("vue").PropType<VcViewerCreatorFunction>;
    mars3dConfig: import("vue").PropType<Mars3dConfig>;
    dcConfig: import("vue").PropType<DCConfig>;
