...
import { VcPrimitiveGroundPolyline, VcPrimitive, VcViewshed } from '../../components/primitives/index.mjs';
...
import { makeCartesian3Array, getGeodesicDistance, getPolylineSegmentHeading, getPolylineSegmentPitch, getHeadingPitchRoll, getPolylineSegmentEndpoint, getFirstIntersection, calculateAreaByPostions, compareCesiumVersion, makeCartesian2 } from '../../utils/cesium-helpers.mjs';
...
function useDrawingSegment(props, ctx, cmpName) {
  ...
  const getHeightPosition = (polyline, movement) => {
    ...
    if (defined(endPoint)) {
      ...
      const worldToWindowCoordinates = compareCesiumVersion(Cesium.VERSION, "1.121") ? SceneTransforms.worldToWindowCoordinates : SceneTransforms["wgs84ToWindowCoordinates"];
