import { getCesiumColor, getCesiumValue } from '../../../utils/util.mjs';
import BaseMaterialProperty from './VcBaseMaterialProperty.mjs';

"use strict";
class VcLineTrailMaterialProperty extends BaseMaterialProperty {
  constructor(options = {}) {
...
export { VcLineTrailMaterialProperty as default };
//# sourceMappingURL=VcLineTrailMaterialProperty.mjs.map
