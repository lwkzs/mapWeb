import { makeDistanceDisplayCondition, makeCartesian2, makeCartesian2Array, makeCartesian3, makeColor, makeColors, makeNearFarScalar, makeMaterial, makeCartesian3Array, makeRectangle, makeBoundingRectangle, makePlane, makePolygonHierarchy, makeTranslationRotationScale, makeQuaternion, makeOptions, makeAppearance, makeImageBasedLighting } from './cesium-helpers';
import type { PropType } from 'vue';
import type { VcPosition, VcRectangle, VcAppearance, VcColor, ProjectionTransforms, VcCallbackPropertyFunction, VcDistanceDisplayCondition, VcCartesian2, VcCartesian3Array, VcCartesian2Array, VcNearFarScalar, VcPolygonHierarchy, VcMaterial, VcBoundingRectangle, VcPlane, VcImageBasedLighting } from './types';
/**
...
declare const customShader: {
    customShader: {
        type: PropType<Cesium.CustomShader>;
    };
};
declare const maximumMemoryUsage: {
    maximumMemoryUsage: {
        type: NumberConstructor;
        default: number;
    };
...
declare const imageBasedLighting: {
    imageBasedLighting: {
        type: PropType<VcImageBasedLighting>;
        watcherOptions: {
            cesiumObjectBuilder: typeof makeImageBasedLighting;
        };
    };
};
/**
