  ...
  setup(props, ctx) {
    ...
    return () => {
      if (canRender.value) {
        ...
        const root = [];
        const renderNavigationContent = vue.h(
          "div",
          {
            ref: rootRef,
        ...
        if (props.teleportToViewer) {
          root.push(vue.h(vue.Teleport, { to: $services.viewer._element }, renderNavigationContent));
        } else {
          root.push(renderNavigationContent);
        }
        if (props.otherOpts !== false) {
          const renderOtherContent = vue.h(
            "div",
            {
              ref: secondRootRef,
          ...
          if (props.teleportToViewer) {
            root.push(vue.h(vue.Teleport, { to: $services.viewer._element }, renderOtherContent));
          } else {
