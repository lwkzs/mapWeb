...
var Drawings = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const pointDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.pointDrawingOpts), props.pointDrawingOpts));
    ...
    const polylineDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.polylineDrawingOpts), props.polylineDrawingOpts));
    const polygonActionOpts = vue.reactive(
      Object.assign({}, defaultProps.defaultOptions.polygonActionOpts, mergeActionOpts("polygonActionOpts"))
    );
    const polygonDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.polygonDrawingOpts), props.polygonDrawingOpts));
    ...
    const rectangleDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.rectangleDrawingOpts), props.rectangleDrawingOpts));
    ...
    const circleDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.circleDrawingOpts), props.circleDrawingOpts));
    ...
    const regularDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.regularDrawingOpts), props.regularDrawingOpts));
    const pinActionOpts = vue.reactive(Object.assign({}, defaultProps.defaultOptions.pinActionOpts, mergeActionOpts("pinActionOpts")));
    const pinDrawingOpts = vue.reactive(lodashEs.merge(lodashEs.cloneDeep(defaultProps.defaultOptions.pinDrawingOpts), props.pinDrawingOpts));
