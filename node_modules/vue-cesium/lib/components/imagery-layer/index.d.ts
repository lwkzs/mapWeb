...
declare const _ImageryLayer: SFCWithInstall<import("vue").DefineComponent<{
    ...
    readyEvent: (payload: import("vue-cesium/es/utils/types").VcImageryProvider) => boolean;
    ...
    onReadyEvent?: (payload: import("vue-cesium/es/utils/types").VcImageryProvider) => any;
}, {
    show: boolean;
