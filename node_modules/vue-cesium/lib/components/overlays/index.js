...
var index$6 = require('./typhoon/index.js');

"use strict";
const components = [index$4["default"], index$3["default"], index$2["default"], index$5["default"], index$1["default"], index$6["default"]];
const install = (app) => {
...
const VcOverlayTyphoon = index$6["default"];
...
exports.typhoonOverlayProps = index$6.typhoonOverlayProps;
...
exports.VcOverlayTyphoon = VcOverlayTyphoon;
