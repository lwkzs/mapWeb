...
class ParticlesComputing {
  ...
  createComputingPrimitives(data, particleSystemOptions, viewerParameters, context) {
    ...
    let calculateSpeedFragText = calculateSpeed_frag["default"];
    if (!webgl2) {
    ...
    let updatePositionFragText = updatePosition_frag["default"];
    if (!webgl2) {
    ...
    let postProcessingPositionFragText = postProcessingPosition_frag["default"];
    if (!webgl2) {
