...
import type { VcCartesian2, VcComponentInternalInstance, VcComponentPublicInstance, VcImageBasedLighting, VcPickEvent, VcPosition, VcReadyObject } from 'vue-cesium/es/utils/types';
declare const emits: {
...
export declare const tilesetPrimitiveProps: {
    ...
    splitDirection: {
        type: PropType<Cesium.SplitDirection>;
        default: number;
    };
    projectTo2D: {
        type: BooleanConstructor;
    ...
    imageBasedLighting: {
        ...
        watcherOptions: {
            cesiumObjectBuilder: typeof import("../../../utils/cesium-helpers").makeImageBasedLighting;
        };
    };
    ...
    pointCloudShading: PropType<Cesium.PointCloudShading>;
