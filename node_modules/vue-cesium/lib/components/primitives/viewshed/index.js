...
var Viewshed$1 = require('../../../shared/shaders/Viewshed.js');
...
var PrimitiveViewshed = vue.defineComponent({
  name: "VcViewshed",
  props: viewshedProps,
  ...
  setup(props, ctx) {
    ...
    unwatchFns.push(
      vue.watch(
        ...
        ([newStartPosition, newEndPosition]) => {
          ...
          updateViewshed(cesiumHelpers.makeCartesian3(vue.toRaw(newStartPosition)), cesiumHelpers.makeCartesian3(vue.toRaw(newEndPosition)));
        },
        {
          deep: true
        }
    ...
    unwatchFns.push(
      vue.watch(
        ...
        (val) => {
          ...
          const viewshed = instance.cesiumObject;
          viewshed.visibleColor = cesiumHelpers.makeColor(val);
        }
      )
    );
    unwatchFns.push(
      vue.watch(
        ...
        (val) => {
          ...
          const viewshed = instance.cesiumObject;
          viewshed.invisibleColor = cesiumHelpers.makeColor(val);
        }
      )
    );
    unwatchFns.push(
    ...
    instance.createCesiumObject = async () => {
      ...
      const viewshed = new Viewshed["default"](viewer.scene, {
        fovH: 120,
        fovV: 60,
        offsetHeight: 1.8,
        visibleColor: cesiumHelpers.makeColor(props.visibleColor),
        invisibleColor: cesiumHelpers.makeColor(props.invisibleColor),
      ...
      viewshed.lineColor = cesiumHelpers.makeColor(props.lineColor);
      viewshed.faceColor = cesiumHelpers.makeColor(props.faceColor);
      return viewshed;
    };
    instance.mount = async () => {
      ...
      let shaderSourceText = Viewshed$1["default"];
      if (!webgl2) {
      ...
      updateViewshed(cesiumHelpers.makeCartesian3(vue.toRaw(props.startPosition)), cesiumHelpers.makeCartesian3(vue.toRaw(props.endPosition)));
...
exports["default"] = PrimitiveViewshed;
exports.viewshedProps = viewshedProps;
