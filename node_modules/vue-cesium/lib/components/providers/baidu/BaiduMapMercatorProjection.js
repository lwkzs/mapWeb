...
class BaiduMapMercatorProjection {
  ...
  inverse(point) {
    ...
    return new Point["default"](lnglat == null ? void 0 : lnglat.lng, lnglat == null ? void 0 : lnglat.lat);
  }
  /**
   * 经纬度坐标转换成平面直角坐标;
  ...
  forward(point) {
    ...
    return new Point["default"](mc == null ? void 0 : mc.lng, mc == null ? void 0 : mc.lat);
  }
  /**
   * 经纬度变换至墨卡托坐标
   * @param Point 经纬度
