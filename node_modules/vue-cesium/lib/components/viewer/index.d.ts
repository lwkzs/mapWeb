...
declare const _Viewer: SFCWithInstall<import("vue").DefineComponent<{
    ...
    viewerCreator: import("vue").PropType<import("./src").VcViewerCreatorFunction>;
    ...
    'update:camera': (evt: import("vue-cesium/es/utils/types").VcCamera) => boolean;
    ...
    "onUpdate:camera"?: (evt: import("vue-cesium/es/utils/types").VcCamera) => any;
}, {
    navigation: boolean;
    shadows: boolean;
