...
import type { VcCamera, VcComponentInternalInstance, VcDatasource, VcTerrainProvider, ViewerWidgetResizedEvent } from 'vue-cesium/es/utils/types';
declare const emits: {
    ...
    'update:camera': (evt: VcCamera) => boolean;
...
declare const _default: import("vue").DefineComponent<{
    ...
    baseLayer: {
        type: import("vue").PropType<false | Cesium.ImageryLayer>;
        default: () => any;
    };
    ...
    viewerCreator: import("vue").PropType<import("./useViewer").VcViewerCreatorFunction>;
    mars3dConfig: import("vue").PropType<import("vue-cesium/es/utils/types").Mars3dConfig>;
    dcConfig: import("vue").PropType<import("vue-cesium/es/utils/types").DCConfig>;
    containerId: StringConstructor;
    ...
    "onUpdate:camera"?: (evt: VcCamera) => any;
}, {
    navigation: boolean;
    shadows: boolean;
    ...
    scene3DOnly: boolean;
    baseLayer: false | Cesium.ImageryLayer;
