...
var index$2 = require('../use-global-config/index.js');
...
function useCommon(props, { emit, attrs }, vcInstance) {
  ...
  const globalConfig = index$2.useGlobalConfig();
        ...
        const unwatch = (_e = vcInstance.proxy) == null ? void 0 : _e.$watch(
          ...
          async (val, oldVal) => {
            ...
            if (hasSetter) {
              ...
              if (!lodashUnified.isEqual(val, oldVal) || Array.isArray(val)) {
  ...
  const transformProp = (prop, value, childProps) => {
    ...
    entityGraphics[prop] && (vcInstance.cesiumClass === "Entity" || vcInstance.cesiumClass.indexOf("DataSource") > 0 || vcInstance.cesiumClass === "VcOverlayDynamic")) {
      ...
      if (shared.isFunction(value) && cmpName) {
      ...
      return (propOption == null ? void 0 : propOption.watcherOptions) && !util.isEmptyObj(value) ? propOption.watcherOptions.cesiumObjectBuilder.call(vcInstance, value, vcInstance.viewer.scene.globe.ellipsoid) : supportCallbackProperty ? new Cesium.CallbackProperty(value, false) : value;
    }
  };
  const getServices = () => {
