...
import type { VcDrawTipOpts, VcEditorOpts, VcDrawingPreRenderDatas, VcMeasurementFormatter } from 'vue-cesium/es/utils/drawing-types';
...
export declare const useDrawingActionProps: {
    ...
    distanceFormatter: PropType<VcMeasurementFormatter>;
    angleFormatter: PropType<VcMeasurementFormatter>;
    areaFormatter: PropType<VcMeasurementFormatter>;
    enableMouseEvent: {
