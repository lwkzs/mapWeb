...
function useDrawingPoint(props, ctx, cmpName) {
  ...
  const getLabelText = (point) => {
    ...
    return `${t("vc.measurement.point.lng")}${angleFormatter(
...
${t("vc.measurement.point.slope")}${angleFormatter(point.slope, (_g = props.measureUnits) == null ? void 0 : _g.slopeUnits, props.locale, (_h = props.decimals) == null ? void 0 : _h.slope)}`;
  };
  ...
  return () => {
    ...
    children.push(
      vue.h(index$2.VcCollectionPoint, {
    ...
    children.push(
      vue.h(index$2.VcCollectionLabel, {
        enableMouseEvent: props.enableMouseEvent,
        labels: labelsRender,
    ...
    cmpName === "VcDrawingPin" && children.push(
      vue.h(index$2.VcCollectionBillboard, {
        enableMouseEvent: props.enableMouseEvent,
