  ...
  const updateLabelPosition = () => {
    computedRenderDatas.value.forEach((polyline, index) => {
      ...
      if (!(positions.length < 2)) {
        ...
        const positionWindow = cesiumHelpers.compareCesiumVersion(Cesium.VERSION, "1.121") ? SceneTransforms.worldToWindowCoordinates(scene, startPosition, {}) : SceneTransforms["wgs84ToWindowCoordinates"](scene, startPosition, {});
        ...
        for (let i = 1; i < positions.length; i++) {
          const positionWindow2 = cesiumHelpers.compareCesiumVersion(Cesium.VERSION, "1.121") ? SceneTransforms.worldToWindowCoordinates(scene, positions[i], {}) : SceneTransforms["wgs84ToWindowCoordinates"](scene, positions[i], {});
