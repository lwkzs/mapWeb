...
var TimelineHighlightRange = require('./TimelineHighlightRange.js');
var TimelineTrack = require('./TimelineTrack.js');
...
class VcTimeline {
  ...
  addHighlightRange(color, heightInPx, base) {
    const newHighlightRange = new TimelineHighlightRange["default"](color, heightInPx, base);
    this._highlightRanges.push(newHighlightRange);
    this.resize();
    return newHighlightRange;
  }
  addTrack(interval, heightInPx, color, backgroundColor) {
    const newTrack = new TimelineTrack["default"](interval, heightInPx, color, backgroundColor);
